...
export class WorkerManager {
  ...
  private _configChangeListener: monacoEditor.IDisposable;
  private _worker: monacoEditor.editor.MonacoWebWorker<GraphQLWorker> | null =
    null;
