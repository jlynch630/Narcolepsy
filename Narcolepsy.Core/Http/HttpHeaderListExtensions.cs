namespace Narcolepsy.Core.Http {
    ...
    public static class HttpHeaderListExtensions {
        public static void SetAutoHeader(this IList<HttpHeader> list, string name, string value, string note, bool userModifiable = true) {
        ...
        public static void RemoveAutoHeader(this IList<HttpHeader> list, string name) {
            ...
            IEnumerable<HttpHeader> Existing = list.Where(c => c.Name.Equals(name, StringComparison.OrdinalIgnoreCase) && c.Note is not null).ToArray();

            foreach (HttpHeader Header in Existing)
                list.Remove(Header);
        }

        public static void SetHeader(this IList<HttpHeader> list, string name, string value, bool enabled = true, bool userModifiable = true, string? note = null) {
        ...
        public static void AddHeader(this IList<HttpHeader> list, string name, string value, bool enabled = true, bool userModifiable = true, string? note = null) {
        ...
        public static void RemoveHeader(this ICollection<HttpHeader> list, string name) {
            foreach (HttpHeader Existing in list.Where(c => c.Name.Equals(name, StringComparison.OrdinalIgnoreCase)).ToArray())
